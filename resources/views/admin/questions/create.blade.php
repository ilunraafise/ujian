        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="flex flex-col gap-10 px-5 mt-5">
                <div class="breadcrumb flex items-center gap-[30px]">
                    ...
                    <span class="text-[#7F8190] last:text-[#0A090B]">/</span>
                    <a href="#" class="text-[#7F8190] last:text-[#0A090B] last:font-semibold">Buat Pertanyaan</a>
                </div>
            </div>
            ...
            id="add-question" class="mx-[70px] mt-[30px] flex flex-col gap-5" enctype="multipart/form-data">
                @csrf
                <h2 class="font-bold text-2xl">Tambah Pertanyaan Baru</h2>
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div class="flex items-center w-[500px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] focus-within:border-2 focus-within:border-[#0A090B]">
                        ...
                        <input type="text" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" placeholder="Tulis pertanyaan di sini" name="question">
                    </div>
                    <div class="flex flex-col gap-[10px]">
                    <p class="font-semibold">Upload Gambar Pertanyaan (Opsional)</p>
                    <div class="flex items-center w-[500px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] focus-within:border-2 focus-within:border-[#0A090B]">
                        <div class="mr-[14px] w-6 h-6 flex items-center justify-center overflow-hidden">
                            <img src="{{asset('images/icons/upload.svg')}}" class="h-full w-full object-contain" alt="icon">
                        </div>
                        <input type="file" name="image" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" accept="image/*">
                    </div>
                </div>
                </div>
                <div class="flex flex-col gap-[10px]">
                    ...
                    @for($i =0; $i < 4; $i++)
                        <div class="flex items-center gap-4">
                            <div class="flex items-center w-[500px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] focus-within:border-2 focus-within:border-[#0A090B]">
                                ...
                                <input type="text" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" placeholder="Tulis jawaban di sini" name="answers[]">
                            </div>
                            <label class="font-semibold flex items-center gap-[10px]"
                                ...
                                value="{{ $i }}"
                                name="correct_answer"
                                class="w-[24px] h-[24px] appearance-none checked:border-[3px] checked:border-solid checked:border-white rounded-full checked:bg-[#01923F] ring ring-[#EEEEEE]"
                                />
                                Benar
                            </label>
                        </div>
